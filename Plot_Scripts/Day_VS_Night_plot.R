...
# Convert the TIMESTAMP_START to a character string, then to a datetime object
...
# Filter data by a specific month, e.g., July (month = 7)
data_filtered <- data %>% filter(Month == 7)

# Define day and night periods (6 AM to 6 PM for day, 6 PM to 6 AM for night)
